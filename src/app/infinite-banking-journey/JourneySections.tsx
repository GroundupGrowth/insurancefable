...
/* Everything on the Infinite Banking journey page BELOW the hero: resources,
   the 4-step framework, personas, testimonials, webinars, free ebooks and the
   must-read article list. Body copy is verbatim from the old WordPress page —
   don't "improve" it.

   Shared by two routes that differ only in their top section:
   - /infinite-banking-journey/      full site chrome + the hero with the calendar
   - /infinite-banking-journey-call/ bare landing page, simple booking header
   Edit once, both stay identical. */
