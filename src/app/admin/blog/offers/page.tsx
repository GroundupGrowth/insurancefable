...
export default function BlogOffersPage() {
  ...
  return (
    <>
      <PageHeader
        title="Sidebar offers & bylines"
        text="Tag-to-eBook rules plus bulk per-post overrides. Individual articles are easier to manage from their own editor page under Blog."
