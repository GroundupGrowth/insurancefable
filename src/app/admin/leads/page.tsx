...
export default function LeadsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Leads"
        text="Every submission from the site's own forms. Forwarded = GHL received it too; not forwarded = it lives only here (paste that source's webhook at Books or Forms so new ones flow to GHL)."
        actions={
