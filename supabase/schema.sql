...
insert into public.embed_slots (slot_key, label, category) values
  ...
  ('form:quiz-advice',               'Wealth Strategy Quiz plan request (/quiz/)',           'form'),
  ('page:questionnaire:form',        'Client questionnaire (/questionnaire/)',               'page'),
  ('page:getmyquote:form',           'Get My Quote form (/getmyquote/)',                     'page'),
  ('page:agent-broker:form',         'Agent/broker inquiry (/agent-broker/)',                'page'),
  ('page:agent-partners:form',       'Agent partners application (/agent-partners/)',        'page'),
  ('page:insurance-options-for-long-term-care-expenses:form', 'LTC options request', 'page'),
